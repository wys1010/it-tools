...
<template>
  <c-tooltip :tooltip="$t('home.nav.github')" position="bottom">
    <c-button circle variant="text" href="https://github.com/wys1010/it-tools" target="_blank" rel="noopener noreferrer"
  ...
  <c-tooltip :tooltip="$t('home.nav.twitter')" position="bottom">
    <c-button circle variant="text" href="https://twitter.com/wqs1010" rel="noopener" target="_blank"
